      ...
      {bet.status === 'WAITING' && (
        <div className="flex flex-col sm:flex-row gap-4">
          <button
            ...
            disabled={loading}
            className="flex-1 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:bg-green-300 font-medium px-4"
          >
          ...
          <button
            ...
            disabled={loading}
            className="flex-1 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 disabled:bg-red-300 font-medium px-4"
          >
