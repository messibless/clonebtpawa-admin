...
const TennisCreate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('📤 Sending tennis match data:', payload);
      const response = await api.post('/tennis/', payload);
      console.log('✅ Match created:', response.data);

      alert('tennis match created successfully!');
      navigate('/tennis');
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm p-6 max-w-3xl mx-auto">
      <h2 className="text-2xl font-bold mb-6">Create tennis Match</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        >
          {loading ? 'Creating...' : 'Create tennis Match'}
        </button>
      </form>
    </div>
  );
