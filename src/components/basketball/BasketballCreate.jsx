...
const BasketballCreate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('📤 Sending basketball match data:', payload);
      const response = await api.post('/basketball/', payload);
      console.log('✅ Match created:', response.data);

      alert('basketball match created successfully!');
      navigate('/basketball');
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm p-6 max-w-3xl mx-auto">
      <h2 className="text-2xl font-bold mb-6">Create basketball Match</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        >
          {loading ? 'Creating...' : 'Create basketball Match'}
        </button>
      </form>
    </div>
  );
...
export default BasketballCreate;