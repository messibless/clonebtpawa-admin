...
const FixturesList = () => {
  ...
  const fetchFixtures = async () => {
    ...
    try {
      ...
      console.error(err);
      setError('Failed to load football fixtures.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <h2 className="text-2xl font-bold text-gray-800">Match Football</h2>
        <div className="flex gap-2">
          ...
          <button onClick={() => navigate('/create-fixture')}
      ...
      {fixtures.length === 0 ? (
        <div className="text-center py-12 bg-gray-50 rounded-lg">
          ...
          <button onClick={() => navigate('/create-fixture')} className="mt-4 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Create First Fixture</button>
        </div>
      ) : (
            ...
            <div key={fixture.id} className={`relative bg-white rounded-xl shadow-sm hover:shadow-md border-2 ${selectedFixtures.includes(fixture.id) ? 'border-purple-500' : 'border-transparent'}`}>
              ...
              <div className="p-5">
                ...
                <div className="flex gap-2 pt-3 border-t">
                  <button onClick={() => navigate(`/edit-fixture/${fixture.id}`, { state: { fixture } })}
