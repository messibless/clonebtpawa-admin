...
const CreateFixture = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('📤 Sending efootball match data:', payload);
      const response = await api.post('/efootball/', payload);
      console.log('✅ Match created:', response.data);

      alert('efootball match created successfully!');
      navigate('/efootball');
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm p-6 max-w-3xl mx-auto">
      <h2 className="text-2xl font-bold mb-6">Create EFootball Match</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        >
          {loading ? 'Creating...' : 'Create eFootball Match'}
        </button>
      </form>
    </div>
  );
