...
const CreateFixture = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('📤 Sending football match data:', payload);
      const response = await api.post('/football/', payload);
      console.log('✅ Match created:', response.data);

      alert('Football match created successfully!');
      navigate('/football');
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm p-6 max-w-3xl mx-auto">
      <h2 className="text-2xl font-bold mb-6">Create Football Match</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        >
          {loading ? 'Creating...' : 'Create Football Match'}
        </button>
      </form>
    </div>
  );
